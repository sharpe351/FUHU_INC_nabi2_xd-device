...
LOCAL_STEM := nabi2_xd/device-partial.mk

\$(call inherit-product-if-exists, vendor/nabi2xd/\$(LOCAL_STEM))
...
LOCAL_STEM := nabi2_xd/BoardConfigPartial.mk
...
# Nabi2_xd blob(s) necessary for nabi2_xd hardware
PRODUCT_PACKAGES := \\
    btmacreader \\
    camera.tegra \\
    libdrmwvmplugin \\
...
LOCAL_MODULE_OWNER := nabi2_xd
LOCAL_SRC_FILES := libsensors.isl29018.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
...
LOCAL_MODULE_OWNER := nabi2_xd
LOCAL_SRC_FILES := libsensors.isl29028.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := \$(TARGET_OUT)/lib
...
include \$(CLEAR_VARS)
LOCAL_MODULE := sensors.nabi2_xd   
LOCAL_MODULE_OWNER := asus
LOCAL_SRC_FILES := sensors.nabi2_xd.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := \$(TARGET_OUT)/lib/hw
...
LOCAL_SRC_FILES := libnvhdmi3dplay_jni.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := \$(TARGET_OUT)/lib
LOCAL_MODULE_TAGS := optional
...
include \$(CLEAR_VARS)
LOCAL_MODULE := libnvmm_vc1_video
LOCAL_SRC_FILES := libnvmm_vc1_video.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := \$(TARGET_OUT)/lib
LOCAL_MODULE_TAGS := optional
...
include \$(CLEAR_VARS)
LOCAL_MODULE := libnvomxadapter
LOCAL_SRC_FILES := libnvomxadapter.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_PATH := \$(TARGET_OUT)/lib
LOCAL_MODULE_TAGS := optional
...
include \$(CLEAR_VARS)
LOCAL_MODULE := nvram_4334
LOCAL_SRC_FILES := nvram_4334.txt
...
include \$(CLEAR_VARS)
LOCAL_MODULE := nvram_4334r1
LOCAL_SRC_FILES := nvram_4334r1.txt
LOCAL_MODULE_SUFFIX := .txt
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := \$(TARGET_OUT_ETC)
LOCAL_MODULE_TAGS := optional
...
# NVIDIA blob(s) necessary for Nabi_XD hardware
PRODUCT_PACKAGES := \\
    nvavp_os_0ff00000 \\
    nvavp_os_eff00000 \\
    nvavp_vid_ucode_alt \\
...
# Widevine blob(s) necessary for nabi2_xd hardware
PRODUCT_PACKAGES := \\
    libdrmdecrypt \\
    libwvm \\
    libwvdrm_L1 \\
...
# Invensense blob(s) necessary for nabi XD hardware
PRODUCT_PACKAGES := \\
    libinvensense_hal \\
    libmllite \\
    libmplmpu
...
mv $ASUSDIR/libnvhdmi3dplay_jni.so $TARGET
...
mv $ASUSDIR/libnvomxadaptor.so $TARGET
...
mv $ASUSDIR/nvram_4334.txt $TARGET
mv $ASUSDIR/nvram_4334r1.txt $TARGET
# WIDEVINE
